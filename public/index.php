...
<main class="wrap">
    ...
    <?php else: ?>
        <section class="hero">
            <div class="hero-left">
                <h1><?= $view === 'watchlist' ? 'Your Watchlist' : 'Discover Movies' ?></h1>
                <p class="muted">
                    Posters, ratings, and a clean watchlist — Netflix vibes, but for <strong>MANGO</strong>.
                </p>
            </div>
        ...
        <?php if ($emptyState !== null): ?>
            <section class="panel">
                ...
                <div class="cta-row">
                    ...
                    <a class="btn btn-ghost" href="seed.php">Seed sample movies</a>
                </div>
            </section>
        <?php else: ?>
...
<footer class="footer">
    <div class="footer-inner">
        ...
        <span class="muted">Built with PHP + HTML + CSS</span>
    </div>
</footer>
</body>
</html>
